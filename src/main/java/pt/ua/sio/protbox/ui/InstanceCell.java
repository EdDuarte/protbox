...
public class InstanceCell extends JLabel {
    ...
    InstanceCell(final Registry directory){
        ...
        JLabel icon = new JLabel(new ImageIcon(Constants.ASSETS.get("instance.png")));
        ...
        revertButton = new JLabel(new ImageIcon(Constants.ASSETS.get("trash.png")));
        ...
        userButton = new JLabel(new ImageIcon(Constants.ASSETS.get("user.png")));
        ...
        configButton = new JLabel(new ImageIcon(Constants.ASSETS.get("config.png")));
