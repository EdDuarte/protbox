...
import pt.ua.sio.protbox.core.synchronization.Sync;
...
public class TrayApplet extends JDialog {
    ...
    public static enum TrayStatus {
        OKAY(Constants.ASSETS.get("box.png"), Constants.ASSETS.get("done.png"), "Up to date and secure"),
        LOADING(Constants.ASSETS.get("vfl3Wt7C.gif"), Constants.ASSETS.get("sync.png"), "<EXTRA>..."),
        UPDATING(Constants.ASSETS.get("vfl3Wt7C.gif"), Constants.ASSETS.get("sync.png"), "Updating (<EXTRA>)...");
//        ERROR(Constants.ASSETS.get("box.png"), Constants.ASSETS.get("done.png"), "Error!");
    ...
    private TrayApplet() {
        ...
        addFolder.setIcon(new ImageIcon(Constants.ASSETS.get("add.png")));
        ...
        JLabel separator = new JLabel(new ImageIcon(Constants.ASSETS.get("separator.png")));
        separator.setLayout(null);
        separator.setBounds(0, 40, 310, 2);
        this.add(separator);

        JLabel lowerPanelBg = new JLabel(new ImageIcon(Constants.ASSETS.get("lower_side.png")));
