...
import edduarte.protbox.util.TripleRef;
...
//            }
    ...
    private void go2(File usersListFile){
        try{
            ...
            // directory is completely new -> generate the single symmetric key to be used from now on by all users
    ...
    private void addInstance(SecretKey key, String algorithm, boolean isANewDirectory) {
        ...
        } catch (ProtException | GeneralSecurityException | AWTException ex) {
